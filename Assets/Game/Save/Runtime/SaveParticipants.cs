...
namespace MSC.Save
{
    ...
    {
        internal PreparedSaveRestore(IReadOnlyList<PreparedParticipant> participants)
        {
    ...
    public sealed class SaveParticipantRegistry
    {
        ...
        public SaveParticipantRegistry(IEnumerable<ISaveParticipant> participants)
        {
            ...
            DeferredStableEntityStore deferredEntities)
        {
            ...
            SaveRestorePreparationContext context = new SaveRestorePreparationContext(unresolvedContent, deferredEntities);
            ...
            return new PreparedSaveRestore(prepared);
        }
